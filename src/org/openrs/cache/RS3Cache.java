...
import org.openrs.cache.ReferenceTable.Entry;
import org.openrs.util.ByteBufferUtils;
import org.openrs.util.crypto.Djb2;
import org.openrs.util.crypto.Whirlpool;

/**
 * The {@link RS3Cache} class provides a unified, high-level API for modifying
 * the cache of a Jagex game.
 * 
 * @author Graham
 * @author `Discardedx2
 */
public final class RS3Cache implements Closeable {
	...
	/**
	 * Creates a new {@link RS3Cache} backed by the specified {@link FileStore}.
	 * 
	 * @param store
	 *            The {@link FileStore} that backs this {@link RS3Cache}.
	 */
	public RS3Cache(FileStore store) {
		this.store = store;
	}
	...
	/**
	 * Gets the {@link FileStore} that backs this {@link RS3Cache}.
	 * 
